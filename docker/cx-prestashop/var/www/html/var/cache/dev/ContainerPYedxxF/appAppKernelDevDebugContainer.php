...
class appAppKernelDevDebugContainer extends Container
{
    ...
    {
        return $this->services['PrestaShop\\PrestaShop\\Adapter\\Category\\Repository\\CategoryRepository'] = new \PrestaShop\PrestaShop\Adapter\Category\Repository\CategoryRepository(($this->services['doctrine.dbal.default_connection'] ?? $this->getDoctrine_Dbal_DefaultConnectionService()), 'cx_');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'cx-prestashop1.7-mysql', 'port' => '', 'dbname' => 'cx-presta-demo', 'user' => 'root', 'password' => 'xulescode', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setNamingStrategy(($this->services['prestashop.database.naming_strategy'] ?? ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('cx_'))));
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('cx_');
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('uAP6omB6G71552NgQLL9jPPttxP94gNgrSTPIB2OofBVGmQ0TJbV8m80tNjK9DAa'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                64 => 'ps_facetedsearch',
                65 => 'myweather',
                66 => 'customproducttext',
            ],
            'container.autowiring.strict_mode' => true,
            'container.dumper.inline_class_loader' => false,
            'database_host' => 'cx-prestashop1.7-mysql',
            'database_port' => '',
            'database_name' => 'cx-presta-demo',
            'database_user' => 'root',
            'database_password' => 'xulescode',
            'database_prefix' => 'cx_',
            ...
            'secret' => 'uAP6omB6G71552NgQLL9jPPttxP94gNgrSTPIB2OofBVGmQ0TJbV8m80tNjK9DAa',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2023-07-12',
            'locale' => 'es-ES',
            'use_debug_toolbar' => true,
            'cookie_key' => 'eCuh5d7mW8iy6IPFTvXMfXqB8XtrOPZzgftq7HeE8eiBUCKoQ0GcMSfgUDCHZEnS',
            'cookie_iv' => 'izP5SciTw53OKKpsYA3iqj3C7NRetXHv',
            'new_cookie_key' => 'def0000084c81b382bc1274101a4ba63620096aabcdbfce726b82b35f9a851d1b43bf87ed181391363c8d2e69efacc28a103439a7322a3dd4785ac0d3b74a74ac6317de2',
            ...
            'modules_translation_paths' => [
                ...
                21 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                ...
                39 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
            ...
            'kernel.secret' => 'uAP6omB6G71552NgQLL9jPPttxP94gNgrSTPIB2OofBVGmQ0TJbV8m80tNjK9DAa',
